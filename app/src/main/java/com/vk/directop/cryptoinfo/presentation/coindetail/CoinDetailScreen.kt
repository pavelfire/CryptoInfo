...
import com.vk.directop.cryptoinfo.presentation.coindetail.components.CoinTag
import com.vk.directop.cryptoinfo.presentation.coindetail.components.TeamListItem

@OptIn(ExperimentalLayoutApi::class)
@Composable
fun CoinDetailScreen(
    navController: NavController, viewModel: CoinDetailViewModel = hiltViewModel()
) {
